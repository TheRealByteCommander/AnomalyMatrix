...
6. [ ] Kamera konfiguriert (`synthetic` bewusst, `docker-compose.camera.yml` USB, oder `docker-compose.gige.yml`; Station 1–4 Kameras, siehe [`MULTI_CAMERA.md`](./MULTI_CAMERA.md))
