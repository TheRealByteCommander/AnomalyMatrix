...
================================================================================
 ...
 Nützliche Befehle:
   cd $APP_DIR
   docker compose -p $COMPOSE_PROJECT -f docker-compose.yml -f docker-compose.prod.yml --env-file .env.production ps
   docker compose -p $COMPOSE_PROJECT -f docker-compose.yml -f docker-compose.prod.yml --env-file .env.production logs -f api
 ...
 Kamera später aktivieren:
   ...
   Dann: docker compose ... up -d --build edge-acquisition
================================================================================
EOF
